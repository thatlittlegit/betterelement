...
var log = console.log || window.console.log || function () {};
// Warns the console.
var wrn = console.warn || window.console.log || function () {}; // OK, I purposely moved this. :|
    ...
    if (this.toExecuteOnRead === undefined) {
        ...
        for (var i = 0; this.elementsToRead[i] !== undefined; i += 1) {
            ...
            if (stopThisRead === false) {
                ...
                if (this.readFailed === undefined) {} else {
